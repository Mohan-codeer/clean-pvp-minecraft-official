...
public class HudConfig {
	...
	public Map<HudWidget, WidgetSettings> widgets = new EnumMap<>(HudWidget.class);
	...
	public WidgetSettings getWidgetSettings(HudWidget widget) {
		return widgets.computeIfAbsent(widget, ignored -> new WidgetSettings(0.05, 0.05, true));
	}
}
